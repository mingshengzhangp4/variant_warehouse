...
MAX_VERSION=`iquery -ocsv -aq "aggregate(versions(TCGA_${DATE}_RNAseqV2_STD), max(version_id))"|tail -n 1`
iquery -anq "remove_versions(TCGA_${DATE}_RNAseqV2_STD, $MAX_VERSION)"
