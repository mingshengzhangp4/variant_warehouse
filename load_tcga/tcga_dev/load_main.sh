...
#  bash $1/load_cnv.sh $3 BLCA $1 $2
#  bash $1/load_cnv.sh $3 BRCA $1 $2
#  bash $1/load_cnv.sh $3 CESC $1 $2
#  bash $1/load_cnv.sh $3 COAD $1 $2
#  bash $1/load_cnv.sh $3 COADREAD $1 $2
#  bash $1/load_cnv.sh $3 ESCA $1 $2
#  bash $1/load_cnv.sh $3 GBM $1 $2
#  bash $1/load_cnv.sh $3 GBMLGG $1 $2
#  bash $1/load_cnv.sh $3 HNSC $1 $2
#  bash $1/load_cnv.sh $3 KICH $1 $2
#  bash $1/load_cnv.sh $3 KIPAN $1 $2
#  bash $1/load_cnv.sh $3 KIRC $1 $2
#  bash $1/load_cnv.sh $3 KIRP $1 $2
#  bash $1/load_cnv.sh $3 LAML $1 $2
#  bash $1/load_cnv.sh $3 LGG $1 $2
#  bash $1/load_cnv.sh $3 LIHC $1 $2
#  bash $1/load_cnv.sh $3 LUAD $1 $2
#  bash $1/load_cnv.sh $3 LUSC $1 $2
#  bash $1/load_cnv.sh $3 MESO $1 $2
#  bash $1/load_cnv.sh $3 OV $1 $2
#  bash $1/load_cnv.sh $3 PAAD $1 $2
#  bash $1/load_cnv.sh $3 PCPG $1 $2
#  bash $1/load_cnv.sh $3 PRAD $1 $2
#  bash $1/load_cnv.sh $3 READ $1 $2
#  bash $1/load_cnv.sh $3 SARC $1 $2
#  bash $1/load_cnv.sh $3 SKCM $1 $2
#  bash $1/load_cnv.sh $3 THCA $1 $2
#  bash $1/load_cnv.sh $3 THYM $1 $2
#  bash $1/load_cnv.sh $3 UCEC $1 $2
#  bash $1/load_cnv.sh $3 UCS $1 $2
#  bash $1/load_cnv.sh $3 UVM $1 $2
